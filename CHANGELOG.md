...
- Implementation of additional GDPR features in DoutPsi (#535)
...
- #664: DoutPsi v1.3.2 allows sensitive information disclosure (username and password hash).
...
- #176: Add Docker container for DoutPsi development.
...
- #21: Fix DoutPsi installation problems with AJAX requests.
- #66: Trouble with breaks for providers.

## [1.0.0] - 2014-01-19 

First DoutPsi release ever! ☺
