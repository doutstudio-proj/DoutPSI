...
This guide explains how to set up a local CalDAV server (Baikal) for testing calendar sync with DoutPsi.
...
2. You'll see a setup form. Fill it in:
   - **Time zone:** Choose your local time zone (must match DoutPsi).
...
## Connecting DoutPsi to Baikal

1. In DoutPsi, go to the **Calendar** page.
