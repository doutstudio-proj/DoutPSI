...
This guide walks you through installing and setting up DoutPsi on your server.

## What You Need

DoutPsi runs on a web server, just like a regular website. Before you begin, make sure you have:
...
Upload the DoutPsi files to your server using FTP or your hosting's file manager. Place them in a folder like `DoutPsi`, `appointments`, or `book`.

Take note of the URL. For example, if you uploaded to a folder called `DoutPsi`, the URL will look like: `http://your-domain.com/DoutPsi`
...
Open your browser and go to your DoutPsi URL (e.g. `http://your-domain.com/DoutPsi`). You'll see a setup wizard. Fill in your admin account details and company info, then click **Install**.

That's it — DoutPsi is now installed!
...
Finally, add a link to your website (e.g. "Book an Appointment") that points to your DoutPsi URL so customers can find it.
