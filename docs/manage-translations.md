...
DoutPsi supports multiple languages. You can modify existing translations or add your own.
...
If you'd like to contribute your translation to the project, you can submit a [pull request on GitHub](https://github.com/doutpsi/doutpsi) or email it to [contato@doutpsi.com.br](mailto:contato@doutpsi.com.br).
