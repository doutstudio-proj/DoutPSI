...
DoutPsi has a REST API that lets you read and manage all your data (appointments, customers, services, etc.) through HTTP requests. This is useful if you want to connect DoutPsi to other software.

## OpenAPI Specification

The project includes a ready-made [OpenAPI file](https://raw.githubusercontent.com/doutpsi/doutpsi/master/openapi.yml) that describes every endpoint. You can import it into tools like [Postman](https://www.postman.com/) to start making requests right away.
