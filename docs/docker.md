...
Docker lets you run DoutPsi on your computer without installing Apache, PHP, or MySQL manually. Everything runs inside containers — isolated mini-environments that are easy to start and stop.
...
|---------|-----|-------------|
| **DoutPsi** | http://localhost | (your admin account) |
...
2. In DoutPsi, click **Enable Sync** → **CalDAV** and enter:
...
> **Note:** This Docker setup is for **development only**. Don't use it in production. For a production Docker image, see: https://github.com/doutpsi/doutpsi-docker
