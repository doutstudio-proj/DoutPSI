        ...
        try {
            ...
            foreach ($local_events as $local_event) {
                ...
                try {
                    ...
                    // If CalDAV Calendar event is different from DoutPsi appointment then update DoutPsi record.
                    ...
                    // Appointment not found on CalDAV Calendar, delete from DoutPsi.
            ...
            // Add CalDAV Calendar events that do not exist in DoutPsi.
            ...
            // from the calendar synchronization and not from DoutPsi itself).
