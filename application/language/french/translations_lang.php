...
$lang['about_app'] = 'Au sujet d’DoutPsi';
...
$lang['about_app_license'] = 'DoutPsi est fourni sous licence GPLv3. En utilisant le code d’DoutPsi, quelqu’en soit l’usage, vous êtes tenu d’accepter les termes décrits dans l’URL suivante :';
...
$lang['ea_update_success'] = 'DoutPsi à été mis à jour avec succès.';
...
$lang['api_token_hint'] = 'Définissez un jeton secret afin d’activer l’authentification basée sur le jeton de l’API DoutPsi. ';
...
$lang['api'] = 'API';
$lang['api_info'] = 'L’API vous permet d’interagir avec toutes les données de DoutPsi via le protocole HTTP et les points de terminaison API disponibles et créer vos propres intégrations.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Cette intégration vous permet de vous connecter à un serveur LDAP existant et d\'importer automatiquement les utilisateurs dans DoutPsi, tout en leur permettant de se connecter via leur mot de passe de répertoire (le nom d\'utilisateur doit correspondre).';
$lang['host'] = 'Hôte';
$lang['port'] = 'Port';
