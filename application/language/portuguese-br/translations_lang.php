...
$lang['unavailability_periods_hint'] = 'Durante os periodos indisponíveis o profissional não aceitar novos agendamentos.';
...
$lang['edit_working_plan_hint'] = 'Marque os dias e as horas a que a sua empresa aceita agendamentos. Assim será possível agendamentos em horário de atendimento, evitando que os pacientes marquem agendamento fora do horário de atendimento. Este plano de trabalho será o padrão para cada novo registo de profissional, mas é possível mudar o plano de cada profissional separadamente editando o profissional. Depois disso, pode adicionar períodos de descanso.';
...
$lang['about_app_info'] = 'Plataforma é uma aplicação web altamente personalizável que permite que os pacientes marquem eventos através da internet. Além disso, oferece a possibilidade de sincronizar seus dados com o Google Calendar para que possa usá-los com outros serviços.';
$lang['current_version'] = 'Versão atual';
$lang['support'] = 'Suporte';
$lang['about_app_support'] = 'Se  encontrar algum problema ao usar o Plataforma pode procurar o Grupo oficial do Google para obter respostas. Se precisar, pode iniciar um novo tópico na página do Google Code, a fim de ajudar o progresso do desenvolvimento.';
...
$lang['about_app_license'] = 'Plataforma está licenciado sob a licença GPLv3. Ao utilizar o código de Plataforma de qualquer forma concorda com os termos descritos na seguinte url:';
...
$lang['api_token_hint'] = 'Defina um token secreto para habilitar a autenticação baseada em token da API Plataforma.';
$lang['timezone'] = 'Fuso horário';
$lang['overwrite_existing_working_plans'] = 'Isso substituirá os planos de trabalho dos profissionais existentes. Tem certeza de que deseja continuar?';
...
$lang['display_any_provider_hint'] = 'A página de reserva terá uma opção adicional que permite aos pacientes fazerem a reserva sem especificar um profissional.';
...
$lang['limit_customer_access_hint'] = 'Se ativado, profissionais e secretárias só poderão acessar pacientes com os quais tenham um compromisso.';
$lang['url'] = 'URL';
...
$lang['google_analytics_info'] = 'O Google Analytics permite adicionar automaticamente o código de rastreamento e a marcação HTML à página pública e rastrear todas as serviços públicas de reserva.';
$lang['matomo_analytics'] = 'Matomo Analytics';
$lang['matomo_analytics_info'] = 'O Matomo Analytics permite adicionar automaticamente o código de rastreamento e a marcação HTML à página pública e rastrear todas as serviços públicas de reserva.';
$lang['api'] = 'API';
$lang['api_info'] = 'A API permite interagir com todos os dados do Plataforma via protocolo HTTP e os endpoints da API disponíveis e criar suas próprias integrações.';
...
$lang['year'] = 'Ano';
$lang['make_non_working_day'] = 'Este profissional não estará disponível para trabalho no dia selecionado.';
...
$lang['blocked_periods_hint'] = 'Defina períodos de tempo onde as reservas públicas serão desativadas para todos os profissionais (por exemplo, datas fechadas, feriados etc.).';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Esta integração permite conectar-se a um servidor LDAP existente e importar automaticamente usuários para o Plataforma, permitindo que eles façam SSO com sua senha do diretório (o nome de usuário deve corresponder).';
$lang['host'] = 'Host';
$lang['port'] = 'Porta';
...
$lang['display_add_to_google_calendar_info'] = 'Mostrar o botão "Adicionar ao Google Calendar" na página de confirmação da reserva, permitindo que os pacientes adicionem facilmente o agendamento ao seu Google Calendar pessoal.';
...
$lang['data_retention_days_hint'] = 'Defina o número de dias após os quais os dados do paciente serão excluídos automaticamente. Defina como 0 para desativar a exclusão automática.';
