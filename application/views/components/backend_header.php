...
<nav id="header" class="navbar navbar-expand-md navbar-dark bg-primary p-0">
    <div id="header-logo" class="navbar-brand p-1 lh-1">
        ...
        <h6 class="mb-1 mt-1 fw-bold text-white" style="font-size: 15px;">DoutPsi</h6>
        <small class="d-block text-white-50" style="font-size: 12px;">Plataforma de Agendamentos</small>
    </div>
