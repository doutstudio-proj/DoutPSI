...
<head>
    ...
    <title>Installation | DoutPsi</title>
...
<div class="container flex-grow-1">
    <div class="row">
        <div class="col-lg-9 offset-lg-1">
            ...
            <div>
                <h3>Welcome to the DoutPsi installation page.</h3>

                <p class="text-break">
                    This page will help you set the main settings of your DoutPsi installation. You will be able to
                    edit these settings and many more in the backend session of your system. Remember to use the
                    <strong class="text-primary">
                        <?= site_url('user/login') ?>
                    </strong> 
                    URL to connect to the backend section of DoutPsi.

                    If you face any problems during the usage of DoutPsi you can always check the
                    <a href="#/docs.html">Documentation</a> and
                    <a href="https://groups.google.com/group/doutpsi">Support Group</a> for getting help. 
                    You may also submit new issues on
                    <a href="https://github.com/doutpsi/doutpsi/issues">GitHub Issues</a>
            ...
            <div class="mb-3">
                <h3>License</h3>
                DoutPsi is licensed under the <span class="badge text-bg-primary">GPL-3.0 license</span>. By using the
                code of DoutPsi in any way <br> you agree with the terms described in the following url:
